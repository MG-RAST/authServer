...
use constant AUTH_KEYWORD => "auth";
use constant AUTH_PREFIX => "oago4711";

use constant SMTP => "smtp.mcs.anl.gov";

@ISA = qw(Exporter);
@EXPORT = qw(SESSION_COOKIE_NAME USER_DB SESSION_TIMEOUT ADMIN_EMAIL BASE_URL IMAGE_DIR JS_DIR CSS_DIR ALLOW_REGISTER_APPLICATION ALLOW_REGISTER_USER APPLICATION_NAME TRUSTED APPLICATION_URL SMTP SHOCK_URL SHOCK_AUTH DBI_CONNECT APP_SECRET AUTH_KEYWORD AUTH_PREFIX);
